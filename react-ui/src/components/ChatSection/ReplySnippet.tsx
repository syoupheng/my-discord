...
import MessageItemProvider, { MessageItemContext } from "../../providers/MessageItemProvider";
...
const ReplySnippet = ({ referencedMessage }: Props) => {
  ...
  return (
    <div className="mb-1 flex items-center text-sm text-h-secondary leading-[1.125rem] relative whitespace-pre select-none before:content-[''] before:block before:absolute before:top-1/2 before:right-full before:bottom-0 before:left-[-36px] before:mr-1 before:mt-[-1px] before:ml-[-1px] before:border-l-2 before:border-l-primary-dark-500 before:border-b-0 before:border-r-0 before:border-t-2 before:border-t-primary-dark-500 before:rounded-tl-md">
