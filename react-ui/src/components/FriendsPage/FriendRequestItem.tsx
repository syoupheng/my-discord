    ...
    <FriendItemContainer>
      ...
      <div className="ml-2 flex">
        {friendRequest.requestStatus === "RECEIVED" ? (
          <>
            <FriendActionBtn icon={<ValidateIcon />} description="Accepter" hoverColor="green" />
            <FriendActionBtn icon={<CancelIcon />} description="Ignorer" hoverColor="red" />
          </>
        ) : (
          <FriendActionBtn icon={<CancelIcon />} description="Annuler" hoverColor="red" />
        )}
      </div>
    </FriendItemContainer>
  );
